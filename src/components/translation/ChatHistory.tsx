  ...
  if (translations.length === 0) {
    return (
      <div className={cn(
        ...
        <div className="w-16 h-16 rounded-full bg-brand-steel-blue/50 flex items-center justify-center mb-4">
          <svg
            viewBox="0 0 24 24"
            className="w-8 h-8 text-brand-fog"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
          >
        ...
        <p className="text-body-sm text-brand-fog text-center">
          No conversation yet
        </p>
        <p className="text-caption text-brand-harbor mt-1 text-center">
    ...
    >
      ...
      <div
        className={cn(
          ...
          isCustomer
            ? 'bg-brand-steel-blue/50 rounded-tl-sm'
            : 'bg-info-600/20 rounded-tr-sm'
        )}
      >
        <p
      ...
      <div
        className={cn(
          ...
          isCustomer
            ? 'border-brand-harbor/30 bg-brand-deep-ocean/50'
            : 'border-info-400/30 bg-info-600/10'
        )}
      >
        <p
          className="text-body-sm text-brand-sea-foam"
      ...
      <div className="flex items-center gap-2 text-caption">
        ...
        {translation.processingTimeMs && (
          <span className="text-brand-harbor">
...
function ConfidenceBar({ level }: ConfidenceBarProps): React.ReactElement {
  ...
  return (
    <div className="w-12 h-1.5 rounded-full bg-brand-steel-blue overflow-hidden">
      <div
